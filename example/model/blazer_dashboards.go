...
JSON Sample
-------------------------------------
{    "id": 76,    "creator_id": 2,    "name": "OJhLIJTHBAFwIWZcxwrnLosUn",    "created_at": "2033-08-03T17:59:33.147289267-04:00",    "updated_at": "2163-08-18T06:31:58.704720108-04:00"}



*/

// BlazerDashboards_ struct is a row record of the blazer_dashboards table in the rocket_development database
type BlazerDashboards_ struct {
...
func (b *BlazerDashboards_) TableName() string {
	return "blazer_dashboards"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (b *BlazerDashboards_) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (b *BlazerDashboards_) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (b *BlazerDashboards_) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (b *BlazerDashboards_) TableInfo() *TableInfo {
